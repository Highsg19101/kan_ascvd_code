...
class MultKAN(nn.Module):
    ...
    def plot(self, folder="./figures", graph_folder="./results", save_graph=False ,beta=3, metric='backward', scale=0.5, tick=False, sample=False, in_vars=None, out_vars=None, title=None, varscale=1.0):
        '''
        plot KAN
        ...
        if save_graph:
            plt.savefig(f'{graph_folder}/{str(title)}.png', dpi=600)
        plt.axis('off')
